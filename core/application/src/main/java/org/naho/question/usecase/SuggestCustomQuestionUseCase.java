...
public class SuggestCustomQuestionUseCase implements SuggestCustomQuestionInputPort {

    private final AiChatPort aiChatPort;

    @Override
    public SuggestCustomQuestionResult suggestCustomQuestion(SuggestCustomQuestionCommand command) {
        ...
        return new SuggestCustomQuestionResult(questionJp);
    }
}
