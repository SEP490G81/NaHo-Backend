...
public enum SpeakingQuestionErrorCode implements ErrorCode {
    ...
    SPEAKING_QUESTION_LOCKED("QST_A006", SpeakingQuestionTitleMessageKey.SPEAKING_QUESTION_LOCKED_TITLE, 400),
    SPEAKING_QUESTION_DAILY_LIMIT_EXCEEDED("QST_A007", SpeakingQuestionTitleMessageKey.SPEAKING_QUESTION_DAILY_LIMIT_EXCEEDED_TITLE, 429),
    SPEAKING_QUESTION_EVALUATION_FAILED("QST_A008", SpeakingQuestionTitleMessageKey.SPEAKING_QUESTION_EVALUATION_FAILED_TITLE, 400);
