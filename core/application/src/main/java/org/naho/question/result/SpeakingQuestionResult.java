...
public record SpeakingQuestionResult(
        Long id,
        Long userId,
        List<GrammarResult> grammars,
    ...
    public static class Builder {
        ...
        private Long id;
        private Long userId;
        private List<GrammarResult> grammars;
        private List<VocabularyResult> vocabularies;
        ...
        public Builder grammars(List<GrammarResult> grammars) {
            this.grammars = grammars;
            return this;
        }

        public Builder vocabularies(List<VocabularyResult> vocabularies) {
        ...
        public SpeakingQuestionResult build() {
            return new SpeakingQuestionResult(
                    id,
                    userId,
                    grammars,
                    vocabularies,
