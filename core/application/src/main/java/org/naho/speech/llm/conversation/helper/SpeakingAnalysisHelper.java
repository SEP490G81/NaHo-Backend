...
import org.naho.speech.llm.conversation.internal.AnalysisContext;
import org.naho.speech.llm.conversation.internal.ParsedScores;
import org.naho.speech.llm.conversation.result.SpeakingAnalysisReportResult;
...
public class SpeakingAnalysisHelper {
    ...
    public double extractLlmScore(JsonNode root, String fieldName) {
    ...
    public SpeechAssessment persistSpeechAssessment(SpeechAssessment azureResult, Long answerHistoryId) {
        SpeechAssessment speechAssessment = SpeechAssessment.builder()
                ...
                .averageScore(azureResult.getAverageScore())
                .answerHistoryId(answerHistoryId)
                .build();
        return answerHistoryRepositoryPort.saveSpeechAssessment(speechAssessment);
    }

    public void persistWordAssessments(List<WordAssessment> azureWords, Long speechAssessmentId) {
    ...
    public AnalysisContext prepareAnalysis(SpeakingAnalysisCommand command) {
