...
public class SpeakingSessionHelper {
  ...
  public List<Map<String, String>> getSlidingWindowMessages(String sessionId) {
  ...
  public String toAudioBase64(String sessionId, String text) {
    try {
      ...
      System.out.println("[SpeakingSessionHelper] TTS failed for session " + sessionId + ": " + e.getMessage());
      return null;
    }
  }
