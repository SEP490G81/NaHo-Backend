...
public enum TopicErrorCode implements ErrorCode {
    ...
    TOPIC_UPDATE_FORBIDDEN("TOPIC_A005", TopicTitleMessageKey.TOPIC_UPDATE_FAILED_TITLE),
    TOPIC_DELETE_FORBIDDEN("TOPIC_A006", TopicTitleMessageKey.TOPIC_DELETE_FAILED_TITLE);
