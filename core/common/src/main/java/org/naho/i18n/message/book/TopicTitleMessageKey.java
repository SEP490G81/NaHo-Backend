...
public final class TopicTitleMessageKey {
    ...
    public static final String TOPIC_UPDATE_FAILED_TITLE = "topic.update.failed.title";
    public static final String TOPIC_DELETE_FAILED_TITLE = "topic.delete.failed.title";
