...
public final class VocabularyQuestionTitleMessageKey {
    public static final String VOCABULARY_QUESTION_NOT_FOUND_TITLE =
            "vocabulary_question.not.found.title";
    public static final String VOCABULARY_IMPORT_FAILED_TITLE =
            "vocabulary.import.failed.title";
    public static final String VOCABULARY_EXPORT_NOT_FOUND_TITLE =
