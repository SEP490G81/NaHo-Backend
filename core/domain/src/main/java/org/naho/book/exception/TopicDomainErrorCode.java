...
public enum TopicDomainErrorCode implements ErrorCode {
    ...
    BOOK_ID_EMPTY("TOPIC_003", TopicTitleMessageKey.TOPIC_CREATION_FAILED_TITLE, 400),
    TOPIC_ORDER_INDEX_EMPTY("TOPIC_004", TopicTitleMessageKey.TOPIC_CREATION_FAILED_TITLE, 400);
