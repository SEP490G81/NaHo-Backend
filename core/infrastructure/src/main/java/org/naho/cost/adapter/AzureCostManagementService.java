...
@Slf4j
@Component
public class AzureCostManagementService implements AzureCostManagementPort {
    ...
    public AzureCostManagementService(AzureCostConfigProperties configProperties) {
    ...
    private JsonNode executePostQuery(String url, String token, Object bodyObj) throws Exception {
        ...
        try {
            ...
            log.error("Azure Cost Query API HTTP failure [status={}]: {}", e.getStatusCode(), e.getResponseBodyAsString());
            throw e;
        }
    }
}
