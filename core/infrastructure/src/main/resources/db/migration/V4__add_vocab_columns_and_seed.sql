-- Alter vocabularies table to add missing kana and kanji columns
ALTER TABLE vocabularies ADD COLUMN kana VARCHAR(255) NULL;
ALTER TABLE vocabularies ADD COLUMN kanji VARCHAR(255) NULL;
...
VALUES (1, NOW(), NULL, 'Topic 1: 友だちを外出にさそう', 'Giới thiệu và mời bạn đi chơi', NULL, NULL, 'ACTIVE', 1.0, NULL, 1, 1),
       (2, NOW(), NULL, 'Topic 2: 住むところをさがす', 'Tìm kiếm nhà ở', NULL, NULL, 'ACTIVE', 2.0, NULL, 1, 1);
...
VALUES (1, NOW(), NULL, 'Lesson 1', 'Bài 1', NULL, NULL, 'ACTIVE', 1.0, 1),
       (2, NOW(), NULL, 'Lesson 2', 'Bài 2', NULL, NULL, 'ACTIVE', 1.0, 2);
...
VALUES (1, NOW(), NULL, '友だちを外出にさそう／さそいをうける', 'Mời bạn đi chơi / Nhận lời mời', NULL, NULL, 'ACTIVE', 1.0, 1),
       (2, NOW(), NULL, 'りゆうを言ってさそいをことわる', 'Đưa ra lý do từ chối lời mời', NULL, NULL, 'ACTIVE', 2.0, 1),
       (3, NOW(), NULL, 'りゆうを言ってやくそくをキャンセルする', 'Đưa ra lý do hủy hẹn', NULL, NULL, 'ACTIVE', 3.0, 1),
       (4, NOW(), NULL, 'おわびのメールとへんじのメールから、じじつと書いた人の気持ちを読みとる', 'Đọc hiểu email xin lỗi', NULL, NULL, 'ACTIVE', 4.0, 1),
       (5, NOW(), NULL, '外出の報告のメールから、じじつと書いた人の気持ちを読みとる', 'Đọc hiểu email báo cáo đi chơi', NULL, NULL, 'ACTIVE', 5.0, 1),
       (6, NOW(), NULL, '住むところをさがすのにだいじなポイントは何か話す', 'Điểm quan trọng khi tìm nhà', NULL, NULL, 'ACTIVE', 1.0, 2),
       (7, NOW(), NULL, '自分が住んでいるところについて話す', 'Nói về nơi mình đang sống', NULL, NULL, 'ACTIVE', 2.0, 2),
       (8, NOW(), NULL, 'サイトのきじから、どんな家に住んでいるか、そのりゆうは何か読みとる', 'Đọc hiểu bài viết về nhà ở', NULL, NULL, 'ACTIVE', 3.0, 2),
       (9, NOW(), NULL, 'サイトのきじから、仕事と住むところについて書いた人の考え方を読みとる', 'Đọc hiểu quan điểm về công việc và chỗ ở', NULL, NULL, 'ACTIVE', 4.0, 2);
...
VALUES (1, NOW(), NULL, 'General conversation', 'General conversation', 'Hãy tự giới thiệu bản thân', 'Hãy tự giới thiệu bản thân', 'ACTIVE', NULL, 1);
