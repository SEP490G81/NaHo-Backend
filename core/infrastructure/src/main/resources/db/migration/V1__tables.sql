...
ALTER TABLE speaking_improved_expressions
    ADD CONSTRAINT FK_SPEAKING_IMPROVED_EXPRESSIONS_ON_SPEAKING_SESSION_ASSESSMENT FOREIGN KEY (speaking_session_assessment_id) REFERENCES speaking_session_assessments (id);
